...
with col1:
    fig_a = px.imshow(
        a, text_auto=show_number, color_continuous_scale="viridis", aspect="equal"
    )
...
with col2:
    fig_b = px.imshow(
        b, text_auto=show_number, color_continuous_scale="viridis", aspect="equal"
    )
